(function ($) {
    "use strict"; $('.validate-input .input100').each(function () {
    ...
    var input = $('.validate-input .input100'); $('.validate-form').on('submit', function () {
        ...
        return check;
    }); $('.validate-form .input100').each(function () { $(this).focus(function () { hideValidate(this); $(this).parent().removeClass('true-validate'); }); }); function validate(input) {
